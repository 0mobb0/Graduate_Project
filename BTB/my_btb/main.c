...
int main(int argc, char **argv)
{
	...
	static struct option long_options[] = {
		...
		{ "iterations", required_argument, 0, 'i' },  // 新增参数
		{ NULL, 0, 0, 0 }
	};
	...
	while (1) {
		...
		case 'i':
			...
			if (iterations <= 0 || iterations > 100000) {  // 安全限制
				error(-1, 0, "Invalid iterations value (1-100000)");
			}
			break;
		}
	}
